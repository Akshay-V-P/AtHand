      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-8 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
        ...
        <div className="flex flex-col w-full sm:flex-row items-start sm:items-center gap-5">
          ...
          <div className="flex flex-col space-y-3 min-w-84">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {/* Status Badge */}
              <div className="flex items-center space-x-1.5 bg-yellow-100/60 px-3 py-1 rounded-md text-sm font-medium text-yellow-800">
        ...
        <div className="bg-slate-50 border border-slate-100 p-5 rounded-xl w-full xl:w-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button className="flex-1 xl:flex-none flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span>Approve</span>
            </button>
            <button className="flex-1 xl:flex-none flex items-center justify-center space-x-2 bg-red-700 hover:bg-red-800 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
