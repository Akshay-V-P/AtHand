          ...
          <div>
            ...
            <div className="mt-16 md:mt-24 max-w-md">
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-[1.2]">
                Reliable Services<span className="text-red-500">.</span><br />
                Fair Pricing<span className="text-red-500">.</span><br />
                Trusted Experts<span className="text-red-500">.</span>
              </h1>
              <p className="mt-6 text-[1.1rem] text-gray-600 leading-relaxed font-medium">
                Log in to continue booking trusted professionals near you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center md:items-end">
          <div className="w-full max-w-md">
            ...
            <div className="flex flex-col items-center space-y-6">
              <button className="flex items-center justify-center gap-2 text-gray-600 hover:text-gray-900 font-medium transition-colors">
              ...
              <a href="/signup" className="text-gray-900 font-semibold underline decoration-2 underline-offset-4 hover:text-black transition-colors">
